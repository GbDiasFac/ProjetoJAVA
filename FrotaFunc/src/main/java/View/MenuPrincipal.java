...
public class MenuPrincipal extends JFrame {
    ...
    private void initComponents() {
        ...
        btnFrota.setBackground(new Color(173, 216, 230));
        btnFrota.setPreferredSize(new Dimension(200, 40));

        btnFuncionario.setFont(botaoFonte);
        btnFuncionario.setForeground(Color.BLACK);
        btnFuncionario.setBackground(new Color(144, 238, 144));
        btnFuncionario.setPreferredSize(new Dimension(200, 40));
